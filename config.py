...
def get_args():
    ...
    parser.add_argument('--extract_out_dir1', type=str, help='the directory of images to extract features')
    parser.add_argument('--extract_out_dir2', type=str, help='the directory of images to extract features')
